...
data = [0.18, 0.05333333333333334, 0.02, 0.10666666666666667, 0.3, 0.2733333333333333, 0.013333333333333334,
        ...
        0.133]
def getresult(str_mse):
    return str_mse
async def connect(data, str_mse=''):
    str_mse = str_mse
    # WebSocket连接事件处理函数
    ...
    # WebSocket消息接收事件处理函数
    async def on_message(ws, message, str_mse):
    ...
    async with websockets.connect('ws://192.168.43.222:8080') as ws:
        ...
        await on_message(ws, message, str_mse)
...
# i=0
# while i<2:
#     asyncio.get_event_loop().run_until_complete(connect(data, str_mse=''))
#     # print(str_mes)
#     print(getresult)
#     i += 1
