...
################################################################################
## Form generated from reading UI file 'homeMeVVAf.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(801, 686)
        icon = QIcon()
        icon.addFile(u":/all/img/logo.png", QSize(), QIcon.Normal, QIcon.Off)
...
"color: rgba(255, 255, 255, 255);")
        ...
        self.Title.setGeometry(QRect(60, 10, 121, 25))
        self.Title.setMinimumSize(QSize(121, 25))
...
"background-image:url(:/all/img/minimize_fill.png);\n"
"background-repeat: no-repeat;\n"
"}\n"
"QPushButton:pressed {\n"
...
"QPushButton:hover {\n"
"background-color: rgb(238, 242, 255);\n"
"background-image:url(:/all/img/fullscreen_fill.png);\n"
"background-repeat: no-repeat;\n"
"}\n"
"QPushButton:pressed {\n"
"background-color: rgb(232, 59, 35);\n"
...
"QPushButton:hover {\n"
"	background-color: rgb(238, 242, 255);\n"
"    background-image: url(:/all/img/close_fill.png);\n"
"    background-repeat: no-repeat;\n"
"}\n"
"QPushButton:pressed {\n"
"    background-color: rgb(232, 59, 35);\n"
...
"}")
        ...
        self.Class_QF.setMinimumSize(QSize(160, 80))
        self.Class_QF.setMaximumSize(QSize(200, 80))
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.Target_QF.setMinimumSize(QSize(210, 80))
        self.Target_QF.setMaximumSize(QSize(210, 80))
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.Fps_QF.setMinimumSize(QSize(100, 80))
        self.Fps_QF.setMaximumSize(QSize(200, 80))
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.Model_QF.setMaximumSize(QSize(200, 80))
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/all/img/begin.png", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u":/all/img/pause.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        self.status_bar = QLabel(self.Pause_QF)
        self.status_bar.setObjectName(u"status_bar")
        self.status_bar.setStyleSheet(u"font: 700 11pt \"Segoe UI\";\n"
"color: rgba(0, 0, 0, 140);")

        self.horizontalLayout_4.addWidget(self.status_bar)
...
"        }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"NEUQers", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"Fatigue-Pre", None))
        ...
        self.src_rtsp_button.setToolTip(QCoreApplication.translate("MainWindow", u"\u6444\u50cf\u5934\u672a\u6388\u6743\uff0c\u65e0\u6cd5\u8fdb\u884c\u91cd\u65b0\u68c0\u6d4b\uff01", None))
#endif // QT_CONFIG(tooltip)
        self.src_rtsp_button.setText(QCoreApplication.translate("MainWindow", u"Re-Detect", None))
        self.VersionLabel.setText(QCoreApplication.translate("MainWindow", u"Version: 2.0", None))
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"\"Prediction\" Project of Sleep-deprived driving Based on Deep Learning", None))
        self.settings_button.setText("")
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.char_label.setText(QCoreApplication.translate("MainWindow", u"Detection", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Driver Status", None))
        self.Class_num.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Behavior Detection", None))
        ...
        self.run_button.setShortcut(QCoreApplication.translate("MainWindow", u"Space", None))
